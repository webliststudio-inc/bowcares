...
<head>
    ...
    <title><?php echo $appName?> | User Login Verification</title>
    <meta name="keywords" content="User Login Verification - <?php echo $appName?>" />
    <meta name="description" content="User Login Verification - <?php echo $appName?>" />
</head>
