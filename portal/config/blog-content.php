<?php if ($page == 'blogPage') { ?>
    <div class="page-title-div" data-aos="fade-in" data-aos-duration="1500">
        ...
        <div class="btn-div">
            ...
            <button class="btn" title="ADD NEW BLOG" onclick="sessionStorage.removeItem('useEachPageSession'); _getForm({page: 'editPagesForm', pageCategory: 'BLOG', url: portalMiddleWareUrl});">
